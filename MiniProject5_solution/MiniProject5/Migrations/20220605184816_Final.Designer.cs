...
namespace MiniProject5.Migrations
{
    ...
    [Migration("20220605184816_Final")]
    partial class Final
    {
            ...
            modelBuilder.Entity("MiniProject5.Models.FeatureFilm", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MovieCost = 60.0,
                            Name = "Film3",
                            ReleaseDate = new DateTime(2015, 6, 5, 20, 48, 15, 955, DateTimeKind.Local).AddTicks(5706),
                            DurationInMins = 120
                        });
                });
            ...
            modelBuilder.Entity("MiniProject5.Models.Series", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MovieCost = 50.0,
                            Name = "Series1",
                            ReleaseDate = new DateTime(2017, 6, 5, 20, 48, 15, 953, DateTimeKind.Local).AddTicks(3769)
                        },
                        new
                        {
                            IdMovie = 2,
                            ...
                            MovieCost = 50.0,
                            Name = "Series2",
                            ReleaseDate = new DateTime(2019, 6, 5, 20, 48, 15, 955, DateTimeKind.Local).AddTicks(5325)
                        });
                });
