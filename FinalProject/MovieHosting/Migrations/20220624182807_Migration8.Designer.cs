...
namespace MovieHosting.Migrations
{
    ...
    [Migration("20220624182807_Migration8")]
            ...
            modelBuilder.Entity("MovieHosting.Models.MovieOfWeek", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            IdMovieOfWeek = 1,
                            IdMovie = 1,
                            StartDate = new DateTime(2022, 6, 19, 20, 28, 6, 476, DateTimeKind.Local).AddTicks(2700)
                        });
                });
            ...
            modelBuilder.Entity("MovieHosting.Models.FeatureFilm", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Film_Name2",
                            ReleaseDate = new DateTime(2015, 6, 24, 20, 28, 6, 475, DateTimeKind.Local).AddTicks(5616),
                            DurationInMins = 120
                        });
                });
            ...
            modelBuilder.Entity("MovieHosting.Models.Series", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MovieCost = 5.9900000000000002,
                            Name = "Breaking Bad",
                            ReleaseDate = new DateTime(2013, 6, 24, 20, 28, 6, 473, DateTimeKind.Local).AddTicks(1523)
                        },
                        new
                        {
                            IdMovie = 3,
                            ...
                            Name = "Peaky Blinders",
                            ReleaseDate = new DateTime(2017, 6, 24, 20, 28, 6, 475, DateTimeKind.Local).AddTicks(5935)
                        });
                });
